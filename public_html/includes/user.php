...
class User{
    ...
    private function emailExists($email){
        ...
        // You can protect from sql attack if u dont declare yur variable as shown above ^^
...
//$obj = new User();
//$user = new User();
//echo $user->createUserAccount("Ram","ram@gmail.com","1234567890","Admin");

//echo $user->userLogin("abhi@gmail.com","1234567890");
